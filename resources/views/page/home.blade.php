...
@section('content')
            ...
            <div class="hs-left">
                <div class="hsl-header">
                    <div class="general-text">
                        <h1 class="wow bounceInLeft">Trí Tuệ Nhân Tạo</h1>
                        Xây dựng<br class="show-in-mobile"> Web và Mobile apps <br> <br
                                class="show-in-tablet show-in-mobile"> <strong>với kết quả ấn tượng.</strong>
                    </div>
                    <div class="hsl-subcaption wow bounceInRight">

                        <p>Chúng tôi <strong>phát triển thương hiệu</strong> cùng với việc xây dựng các giải pháp thông
                            minh và ứng dụng trí tuệ nhân tạo.</p>
                    </div>
                </div>
                        ...
                        <div class="hs-items-texts">
                            <div class="hs-item-text">
                                <p>From their early beginning as a real estate boutique in Germany, Engel &amp; Völkers
                                    ...
                                    companies.</p>
                                <a class="hs-btn" target="_blank" href="http://www.evre.nyc/">VIEW PROJECT <span
                            ...
                            <div class="hs-item-text">
                                ...
                                <a data-hash-id="aol" class="js-hs-btn hs-btn" href="#link">VIEW PROJECT <span
                                            class="icon">&raquo;</span></a>
                            </div>
                            <div class="hs-item-text">
                                <p>For over seven decades, Paul Stuart been a purveyor of some of the finest clothing to
                                    be found anywhere in the world.</p>
                                <a data-hash-id="paulstuart" class="js-hs-btn hs-btn" href="#link">VIEW PROJECT <span
                                            class="icon">&raquo;</span></a>
                            </div>
                        </div>
    ...
    <div class="solutions-section shadow">
        ...
        <div class="frame frame-wide">
            <h2 class="wow bounceInDown">Chúng tôi xây dựng thương hiệu<br> dựa trên trí tuệ nhân tạo.</h2>
            <div class="list">
	...
	background-size:cover;">
        ...
        <div class="feat-section-frame feat-home">
            <div class="section-title in-dark">
                <h2><span>DỰ ÁN <br class="show-in-mobile">NỔI BẬT</span></h2>
                <p>Thành công hôm nay của chúng tôi được đo lường bằng những kết quả đã đạt được.</p>
            </div>
            ...
            <div class="clearfix js-expanded-section-bottom js-expanded-section" data-mode="">
                ...
                <div class="es-items clearfix">
                    ...
                    <div class="bfm-awards ready-discuss js-es-item js-es-item-1 tab-lnk txt-tab-lnk">
                        <div class="holder">
                            <div class="txt">Sẵn sàng <span>để</span> thảo luận về <br class="show-in-tablet">dự án của
                                bạn?
                            </div>
                            <a href="#" class="btn-green">Liên Hệ Ngay</a>
                        </div>
                    </div>
    ...
    <div class="industry-section">
        <div class="frame">
            <h2>Chúng tôi phục vụ <br>tất cả các ngành công nghiệp<br class="show-in-mobile"></h2>
            <p class="subheading">Chúng tôi đứng đầu trong ngành công nghiệp <br class="show-in-mobile"> về trí tuệ nhân
                tạo.</p>
            <div class="content">
                <ul class="list">
                    ...
                    <li><a class="enterprise">Doanh Nghiệp</a></li>
                    <li><a class="education">Giáo Dục</a></li>
                    <br class="show-in-mobile">
                    <li><a class="profit">Phi Lợi Nhuận</a></li>
                ...
                <a href="#link" class="button js-ind-open">Xem Thêm</a>
            </div>
	...
	background-size:cover;">
        ...
        <div class="fss-frame">
            <h2>
                <span>3 bước tiếp cận để </span> <br/>phát triển một thương hiệu trực tuyến
            </h2>
                    ...
                    <div class="t-holder">
                        ...
                        <div class="de-blog-item">
                            ...
                            <a class="read-more-anim"
                               href="#"><span>Đọc thêm</span></a>
                        </div>
                        <div class="divider"></div>
                    </div>
                    <div class="shadow">
                        <a class="btn-raq" href="#">TẤT CẢ PRESS</a>
                    </div>
                </div>
                ...
                <div class="lead-col">
                    ...
                    <div class="t-holder">
                        ...
                        <div class="de-blog-item">
                            ...
                            <a class="read-more-anim" href="#"><span>Đọc thêm</span></a>
                        </div>
                        <div class="divider"></div>
                    </div>
                    <div class="shadow">
                        <a class="btn-raq" href="#">TẤT CẢ BLOG </a>
                    </div>
                </div>
            </div>
        </div>
